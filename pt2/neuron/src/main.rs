...
fn main() {
    ...
    // network.insert("the river flows gently through the valley", "en");
    // network.insert("the mountain stands tall against the sky", "en");
    // network.insert("sunlight filters through the leaves of the trees", "en");
    // network.insert("the ocean waves crash against the shore", "en");
    // network.insert("the city lights illuminate the night", "en");
    // network.insert("the flowers bloom in the springtime", "en");
    // network.insert("winter snow blankets the landscape in white", "en");
    // network.insert("lakes reflect the beauty of the surrounding nature", "en");
    // network.insert("the horizon changes into the night", "en");
    // network.insert("my view on the world is shaped by my experiences", "en");
    // network.insert("quick brown dogs are often seen in the park", "en");
    // network.insert("moonlight casts a serene glow over the countryside", "en");
    // network.insert("the stars guide travelers through the night", "en");
    // network.insert("the river's gentle flow soothes the soul", "en");
    // network.insert("the mountain's majestic presence inspires awe", "en");
    // network.insert("sunlight warms the earth and nurtures life", "en");
